...
apiVersion: v1
data:
  GIT_SYNC_PASSWORD: Z2hwX1ZsMFVISEpDQ3k0Q0VObDhWRlR4VGR1MXY2M0hBdDRIQlFEQg==
...
defaultAirflowRepository: harbor.in.camelgames-data.com/camel-docker/airflow
...
ingress:
  ...
  web:
    ...
    hosts: 
      - name: "airflow.in.camelgames-data.com"
...
data:
  ...
  metadataConnection:
    ...
    pass: "bh8HGGkajydvn4"
    protocol: "mysql"
    host: "datagroup.cflp0oafcnzg.us-west-2.rds.amazonaws.com"
    port: 5306
    db: k8s_airflow
    sslmode: disable
...
webserverSecretKey: "49319bad5afffdc3bc66f8b8c0704a74"
...
config:
  ...
  smtp:
    ...
    smtp_starttls: False
    smtp_ssl: True
    smtp_user: data_public@camel4u.com
    smtp_password: gukJm2EfHiEyVfht
    smtp_port: 465
    smtp_mail_from: data_public@camel4u.com
    smtp_timeout: 30
    smtp_retry_limit: 5
  kubernetes:
